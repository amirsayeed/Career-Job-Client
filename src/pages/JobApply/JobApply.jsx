...
const JobApply = () => {
    ...
    return (
        <div className='max-w-md mx-auto my-10 space-y-3'>
            <h2 className="text-3xl">Apply Job for this job: <Link to={`/jobs/${jobId}`} className='underline text-blue-500'>Details</Link></h2>
